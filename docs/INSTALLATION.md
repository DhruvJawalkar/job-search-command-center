...
The script previews its actions, asks where private local data should live, and lets you start empty or with synthetic demo content. The first build normally takes 5–10 minutes depending on network and machine speed.

...
2. Review the static and runtime acceptance evidence for the exact release; maintainers can rerun `scripts/Test-LocalOnlyRuntime.ps1` from the `source` branch.

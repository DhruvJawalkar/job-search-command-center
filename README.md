...
The guided script explains the setup, asks where your private local workspace should live, offers empty or synthetic-demo data, creates the expected folders and a generated database password, builds the containers, and waits for the app to become healthy. Open `http://127.0.0.1:3000` when it finishes.
